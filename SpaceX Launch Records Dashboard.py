...
spacex_df['Payload Mass (kg)'] = spacex_df['Payload Mass (kg)'].astype('int64')
...
def get_scatter(site_dropdown, slider_range):
    ...
    if site_dropdown == 'ALL':
        ...
        scatter_fig = px.scatter(filter_df, x='Payload Mass (kg)', y='class', color="Booster Version Category", title=f'Payload vs Outcome for {site_dropdown}')
        return scatter_fig
